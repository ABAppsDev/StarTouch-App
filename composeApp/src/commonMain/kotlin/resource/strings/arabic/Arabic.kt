...
data class Arabic(
    ...
    override val splitCheck: String = "تقسيم الشيك",
    override val unSplitCheck: String = "ارجاع تقسيم الشيك",
    override val combineCheck: String = "تجميع الشيك",
    override val unCombineCheck: String = "ارجاع تجميع الشيك",
    override val shareItem: String = "مشاركه الصنف",
    override val moveItem: String = "تحريك الصنف",
    override val moveItemToNewCheck: String = "تحريك الصنف الي شيك جديد",
    override val splitAndPay: String = "تقسيم ودفع",
    override val disableTable: String = "تعطيل طرابيزه",
    ...
    override val noOrderAgain: String = "اطلب مجددا",
) : IStringResources