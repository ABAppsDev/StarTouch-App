...
data class OrderTakeAwayState(
    ...
    val orderTakeAwayItemState: List<OrderTakeAwayItemState> = orders.toList(),
...
@Immutable
data class OrderTakeAwayItemState(
...
fun FireItems.toState(): OrderTakeAwayItemState = OrderTakeAwayItemState(
    id = id,
    name = name ?: "",
    unitPrice = price,
